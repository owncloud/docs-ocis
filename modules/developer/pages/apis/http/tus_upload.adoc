...
This documentation shows some basic examples, refer link:https://tus.io/protocols/resumable-upload[tus official site] for more details.
...
// SHORTCODE: {{< tabs "create-upload-url" >}}
...
// SHORTCODE: {{< tab "Response - 201 Created" >}}
----
...
// SHORTCODE: {{< tabs "upload-the-first-chunk" >}}
// SHORTCODE: {{< tab "Request" >}}
[source,shell]
----
...
// SHORTCODE: {{< tabs "upload-the-second-chunk" >}}
// SHORTCODE: {{< tab "Request" >}}
[source,shell]
----
curl -ks -XPATCH https://temporary-upload-url \
...
// SHORTCODE: {{< tabs "creation-with-upload" >}}
// SHORTCODE: {{< tab "Request" >}}
[source,shell]
----
