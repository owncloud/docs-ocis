...
link:https://learn.microsoft.com/en-us/graph/api/resources/drive?view=graph-rest-1.0[MS Graph Drives resource].
...
// SHORTCODE: {{< hint type=info title="Multiple Administration Personas" >}}
...
// SHORTCODE: {{< tab "Response - 204 No Content" >}}
...
// SHORTCODE: {{< tabs "restore-space" >}}
// SHORTCODE: {{< tab "Request" >}}
...
// SHORTCODE: {{< hint type=info title="Body value" >}}
...
// SHORTCODE: {{< hint type=warning title="Data will be deleted" >}}
...
// SHORTCODE: {{< /tab >}}
// SHORTCODE: {{< tab "Response - 400 Bad Request" >}}
