...
To get a list of global envvars used in all services, see the xref:admin:deployment/services/env-vars-special-scope.adoc#global-environment-variables[Global Environment Variables] table in the ocis admin documentation.
...
* See the xref:services/general-info/envvars/new-release-process.adoc[Set the Correct IntroductionVersion] documentation before starting a new release candidate.
...
See the xref:services/general-info/envvars/deprecating-variables.adoc[deprecation rules] documentation for more details.
