...
Ask the developers if envvars of this type have been changed (added or removed). See the xref:services/general-info/envvars/special-envvars.adoc#special-scope-envvars[Special Envvars] documentation for more details on how to manage such a change.
...
If so, process xref:services/general-info/envvars/special-envvars.adoc##fixing-changed-items[Extended Envvars - Fixing Changed Items].
...
* Create xref:services/general-info/envvars/env-var-deltas/index.adoc[Envvar Deltas Between Versions] files according the linked description.
