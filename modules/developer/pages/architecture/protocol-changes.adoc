...
_Proxy can do user based routing_
...
_Gateway can do path or storage provider id based routing_
...
_PROPFIND request against old webdav endpoints_
...
_Handling legacy global namespace webdav endpoints_
