...
Containers are also used in link:https://kubernetes.io/[kubernetes]. Kubernetes is part of a huge ecosystem and is founded on best-of-breed practises to orchestrate large scale container applications and services.
