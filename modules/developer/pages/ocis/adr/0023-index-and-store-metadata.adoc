= 23. Index and store metadata
:toc: right
:toclevels: 3

* Status: accepted
* Deciders: link:https://github.com/butonic[@butonic], link:https://github.com/dschmidt[@theonering], link:https://github.com/micbar[@micbar], link:https://github.com/dragotin[@dragotin]
* Date: 2023-10-17
...
* Graph API is limited, so not _all_ available metadata can be accessed
