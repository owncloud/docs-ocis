= 17. Allow read only external User Management
:toc: right
:toclevels: 3

* Status: proposed
* Deciders: link:https://github.com/butonic[@butonic], link:https://github.com/micbar[@micbar], link:https://github.com/rhafer[@rhafer]
* Date: 2022-02-08
...
* [Link type] [Link to ADR] <!-- example: Refined by xref:0005-example.adoc[ADR-0005] -->
* … <!-- numbers of links can vary -->
* supersedes xref:0003-external-user-management.adoc[3. Use external User Management]
