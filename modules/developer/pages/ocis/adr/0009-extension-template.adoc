...
* Status: proposed
* Deciders: link:https://github.com/c0rby[@c0rby] <!-- optional -->
* Date: 2021-06-10
...
* Use link:https://github.com/tmrts/boilr[boilr]
* Create a template git repository.
* Use link:https://github.com/owncloud/ocis-hello/[ocis-hello] as a "template"
...
=== link:https://github.com/tmrts/boilr[boilr]

We have a boilr template already. link:https://github.com/owncloud/boilr-ocis-extension/[boilr-ocis-extension]
...
=== link:https://github.com/owncloud/ocis-hello/[ocis-hello] as a "template"
