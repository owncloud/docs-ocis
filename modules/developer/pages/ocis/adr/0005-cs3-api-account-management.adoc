...
Technical Story: link:https://github.com/cs3org/cs3apis/pull/119[Write only management API for User and Group resources]
...
* Good, because we already designed link:https://github.com/owncloud/ocis/blob/master/accounts/pkg/proto/v0/accounts.proto#L42-L85[a similar API for the accounts service] the only difference being we (vendors) link:https://github.com/owncloud/ocis/blob/master/accounts/pkg/proto/v0/accounts.proto#L252-L408[define their own messages].
