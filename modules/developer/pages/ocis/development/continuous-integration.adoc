...
====
  ...
  You currently need to build it yourself from this link:https://github.com/drone/drone-cli[source code]. If you are not using master as source, please ensure that this link:https://github.com/drone/drone-cli/pull/175[PR] is included.
====
