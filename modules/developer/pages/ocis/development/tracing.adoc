...
By default, we use link:https://www.jaegertracing.io[Jaeger] for request tracing within oCIS. You can follow these steps
to get started:
...
4. Open up the link:http://localhost:16686[Jaeger UI] to analyze request traces.

For more information on Jaeger, please refer to their link:https://www.jaegertracing.io/docs/1.17/[Documentation].
