...
- This setup reflects xref:migration#stage-6-parallel-deployment.adoc[stage 6 of the oC10 to oCIS migration plan]
...
link:https://github.com/owncloud/ocis/tree/master/deployments/examples/oc10_ocis_parallel[Find this example on GitHub]
...
- Open the `.env` file in a text editor
  ...
  By default ownCloud 10 will be started in the `latest` version. If you want to start a specific version of oCIS set the version to `OC10_DOCKER_TAG=`. Available versions can be found on link:https://hub.docker.com/r/owncloud/ocis/tags?page=1&ordering=last_updated[Docker Hub].
...
For a more simple local ocis setup see xref:../getting-started.adoc[Getting started]
