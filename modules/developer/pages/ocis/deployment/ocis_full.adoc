= Full modular oCIS with WebOffice
:toc: right
:toclevels: 3
...
link:https://github.com/owncloud/ocis/tree/master/deployments/examples/ocis_full[Find this example on GitHub]
...
1. Clone the link:https://github.com/owncloud/web[ownCloud Web repository] on your development machine.
