...
Download the oCIS binary of your preferred version and for your CPU architecture and operating system from link:https://download.owncloud.com/ocis/ocis[download.owncloud.com].
