...
:description: This page gives you an overview of the architecture and the concepts behind ownCloud Infinite Scale. Infinite Scale was designed from the beginning as a data platform providing tools to integrate, organize, share and govern data and metadata.
...
Use this link to download the link:{attachmentsdir}/architecture/ocis-c4-model.dsl[Infinite Scale C4 Model] raw description file.
