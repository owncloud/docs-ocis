...
You can login the webinterface with this admin user and change relevant data accoring your needs. As an example to reach out the webinterface use `\https://localhost:9200`.
