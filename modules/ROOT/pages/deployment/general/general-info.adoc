...
If you have forgotten the password for the admin user or want to change it, run following command. Note that the admin user must already exist:
...
Post running this command and entering a new password, the admin can relogin using the new password.
