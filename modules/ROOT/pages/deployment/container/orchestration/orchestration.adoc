...
NOTE: The following documentation serves as a starting point so you have some guidance for your container orchestration setup of Infinite Scale. ownCloud Professional Services currently do not provide support for container orchestration. Please {oc-contact-url}[contact us] if you are interested in assistance with container orchestration.
