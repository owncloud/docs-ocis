...
NOTE: The following documentation serves as a starting point so that you can help yourself with your container orchestration setup for Infinite Scale. ownCloud Professional Services currently don't provide support for container orchestration. Please {contact-us-url}[contact us] if you are interested in receiving Professional Services for container orchestration.
