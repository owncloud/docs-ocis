...
* Minikube for Mac (arm64/amd64) requires additional configurations to use ingress 
. add domain name to `/etc/hosts`
+
[source,bash]
----
127.0.0.1       ocis.kube.owncloud.test # example
...
. Run minikube tunnel to be expose `80,443` ports
+
[source,bash]
----
minikube tunnel
