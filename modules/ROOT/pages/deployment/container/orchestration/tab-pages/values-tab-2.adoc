...
Note, to improve readbility, syntax highlighting is used. A drawback is that links in comments are not clickable. See the xref:deployment/container/orchestration/val-desc-tab-2.adoc[Values Description] page where the links can be clicked.
