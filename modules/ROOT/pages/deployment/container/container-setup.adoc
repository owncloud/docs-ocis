...
Download the `ocis_keycloak` files from GitHub into your project directory. Open the file .env in a text editor and adjust the environment variables according to your wishes. The default configuration looks like this:
