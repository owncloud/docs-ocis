...
* On most Linux distributions, you can simply install Docker via the package manager. For later use, you might want to install xref:deployment/container/orchestration.adoc[Docker-Compose] as well.
+
