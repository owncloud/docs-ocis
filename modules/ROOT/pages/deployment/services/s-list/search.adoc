...
However, https://tika.apache.org/[Apache Tika] is required for this task. Read the https://tika.apache.org/{tika-version}/gettingstarted.html[Getting Started with Apache Tika] guide on how to install and run Tika or use a ready to run https://hub.docker.com/r/apache/tika[Tika container].
