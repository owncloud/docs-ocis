...
:description: The Infinite Scale Auth Service service is used to authenticate service accounts. Compared to normal accounts, service accounts are Infinite Scale internal only and not available as ordinary users like via LDAP.
