...
* **In case of expired uploads**, the _blob_ and _blob.info_ files will _not_ be removed automatically and a lot of data can pile up eating up storage space over time.
