...
If you want to ensure that you have e.g. a necessary NFS mount point guaranteed up and running _before_ the oCIS service starts up, see xref:deployment/tips/useful_mount_tip.adoc[Start a Service After a Resource is Mounted].
