...
* The maintenance command `ocis storage-users uploads list` has been removed.
...
For a detailed description of the steps to upgrade, see the xref:migration/upgrading_5.0.x_7.0.0.adoc[Upgrading from 5.0.x to 7.0.0] documentation.
