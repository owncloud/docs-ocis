...
NOTE: In configuration variables and comments, you'll often come accross the word oCIS or ocis, short for "ownCloud Infinite Scale", while the product is simply called Infinite Scale.
