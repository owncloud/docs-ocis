...
This documentation addresses administrators and technical oriented management based on their duties as:

* Responsible that services are up and running for users.
* Responsible that the IT infrastructure is inline with the companies complicane regulations.
