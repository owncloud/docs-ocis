...
NOTE: Whenever a configuration change has been made, you need to do a configuration check and reload the nginx configuration. This can be done with two methods as described below where you select your preferred one. For ease of writing, the examples show `sudo nginx -s reload`.
...
NOTE: Whenever a configuration change has been made, you need to do a configuration check and reload the Apache configuration. This can be done with two methods as described below where you select your preferred one. For ease of writing, the examples show `sudo apache2ctl -k graceful`.
