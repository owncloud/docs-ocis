...
The mobile clients and the desktop client work just like with ownCloud server when connected to Infinite Scale if used in their current versions:

* Desktop app version 2.11
* iOS app version 11.10
* Android app version 2.21

At the moment, only the new ownCloud Web interface offers spaces. These will work with the upcoming client versions:
