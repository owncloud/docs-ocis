...
:description: The prerequisites section gives an overview and background about minimum requirements with respect to hardware, virtualisation, operating system and optional software to operate oCIS successfully.
...
* Bare metal
* Virtualised hardware like VMWare, KVM, HyperV, VirtualBox ect.
* Virtualized linux operating system which is docker
