...
// outdated link, page-alias does not work
...
Follow the xref:depl-examples/ubuntu-compose/ubuntu-compose-prod.adoc#installation[Installation] section of the bare metal deployment example.
...
* *Binary* +
For binary deployments, do a graceful shutdown as described in xref:depl-examples/ubuntu-compose/ubuntu-compose-prod.adoc#stopping-infinite-scale[Stopping Infinite Scale].
// outdated link, page-alias does not work
